...
function upload(){
	...
	if(isset($_POST['atualizar'])){
		...
		$config['allowed_types'] = 'gif|jpg|JPG|jpeg|JPEG|png|pdf|zip|rar|doc|docx|xls|xlsx';
		$config['overwrite'] = FALSE;
		$config['file_name'] = url_title(str_ireplace(array('png','jpg','gif'),array('','',''),$_FILES['Filedata']['name']));
	  ...
	  if($this->upload->do_upload('Filedata')){
		 ...
		 if($imagem['file_ext']=='.jpg'||$imagem['file_ext']=='.png'||$imagem['file_ext']=='.gif'){
