...
<div id="header">
    <!-- Banner-->
    <div id="banner">
           <?php $this->load->view('inicio/home_banner_view');?>
    </div>
    <!-- /Banner-->
     ...
     <!-- lOGO -->
       ...
       <!-- Menu -->    
        <div class="menu-principal">
         ...
         <div class="redes">
         <a href="<?php $config->facebook ?>" target="_blank">
         <img class="fc" src="<?php echo base_url()?>public/imagem/layout/facebook.fw.png"></a>
         <img class="sp" src="<?php echo base_url()?>public/imagem/layout/menu-separador.fw.png">
         <a href="<?php $config->instagram ?>" target="_blank"><img class="ex" src="<?php echo base_url()?>public/imagem/layout/extra.fw.png"></a>
         </div>
      </div>
