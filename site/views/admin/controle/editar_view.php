...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr>  
    <td align="right"><strong><?php echo $f['label']?>:</strong></td>
    <td><textarea <?php if(isset($f['notnull'])){echo "class='validate[required]'";}?> <?php echo isset($f['ckeditor'])?'id="texto"':''?> style="width:50%" name="<?php echo $field?>"><?php echo $dados[$field]?></textarea></td>
  </tr>
  <?php }?> 
