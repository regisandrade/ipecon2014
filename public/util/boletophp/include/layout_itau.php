...
<label><input type="button" value="Imprimir Boleto" class="print" onclick="print()" /></label>
<DIV ALIGN="CENTER" class="instrucoes">Instruções
de Impressão</DIV></TD></TR><TR><TD valign=top class=cp>
<DIV ALIGN="left">
<p>
<li class="instrucoes">Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (Não use modo econômico).<br>
<li class="instrucoes">Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens mínimas à esquerda e à direita do formulário.<br>
<li class="instrucoes">Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o código de barras.<br>
<li class="instrucoes">Caso não apareça o código de barras no final, clique em F5 para atualizar esta tela.
<li class="instrucoes">Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
<span class="ld2">
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="../../imagem/layout/marcaBoleto.jpg"></td>
